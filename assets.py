...
def load_assets():
    ...
    assets[MOEDA_IMG] = pygame.transform.scale(assets[MOEDA_IMG], (32, 32))
    assets[OBSTACULO_IMG] = pygame.transform.scale(assets[OBSTACULO_IMG], (64, 128))
